---
title: "EDA project: Women's World Cup passes"
---
...
* `pass.{switch, aerial_won, cross, through_ball, shot_ assist, outswinging, straight, inswinging, goal_assist, cut_back, no_touch, deflected ,miscommunication}`: different pass binary indicators (should be self-explanatory, `NA` means `FALSE`)
