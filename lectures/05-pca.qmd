...
* Side note: there's another viewpoint---**maximizing variance**. That is, if we project all points onto the solid blue line, we maximize the variance of the resulting projected points across all such blue lines
