...
library(broom)
library(gtsummary)
house_prices <- fread("../data/ames-housing.csv") 
```
...
#| out-width: "40%"
#| echo: false
knitr::include_graphics("../images/datatable/pre-survey-QR-code.png")
```

<p style="text-align: center;">
[Pre-Lecture Survey Link](https://forms.gle/53Q9niHiBhYEmtwU9)
</p>
...
#| out-width: "70%"
#| echo: false
knitr::include_graphics("../images/datatable/datatable.png")
```
:::
:::::
...
#| out-width: "80%"
#| echo: false
knitr::include_graphics("../images/datatable/general_syntax.png")
```
...
#| out-width: "70%"
#| echo: false
knitr::include_graphics("../images/datatable/data.png")
```
:::
:::::
...
#| out-width: "40%"
#| echo: false
knitr::include_graphics("../images/datatable/select.png")
```
...
#| out-width: "50%"
#| echo: false
knitr::include_graphics("../images/datatable/mutate.png")
```
...
#| out-width: "50%"
#| echo: false
knitr::include_graphics("../images/datatable/filter.png")
```
...
#| out-width: "40%"
#| echo: false
knitr::include_graphics("../images/datatable/arrange.png")
```
...
#| out-width: "80%"
#| echo: false
knitr::include_graphics("../images/datatable/group_by.png")
```
:::
...
#| out-width: "100%"
#| echo: false
knitr::include_graphics("../images/datatable/summarize.png")
```
:::
:::::
...
#| out-width: "40%"
#| echo: false
knitr::include_graphics("../images/datatable/slido-QR.png")
```
...
#| echo: false
#| out-width: "80%"
knitr::include_graphics("../images/datatable/general-join-syntax.png")
```
...
#| echo: false
#| out-width: "85%"
knitr::include_graphics("../images/datatable/equi-join2.png")
```
...
What if we wanted to take our dataset with the `hw_level` columns and filter for students with a "low" level of homework?

-   We could save the dataset with `hw_level` and use that.
-   We could also pipe statements together.

```{r}
#| echo: false
#| out-width: "75%"
knitr::include_graphics("../images/datatable/pipe.png")
```
...
#| out-width: "60%"
#| echo: false
knitr::include_graphics("../images/datatable/pipe3.png")
```
...
#| out-width: "50%"
#| echo: false
knitr::include_graphics("../images/datatable/plots.png")
```
...
#| out-width: "40%"
#| echo: false
knitr::include_graphics("../images/datatable/boxing.png")
```
...
#| out-width: "75%"
#| echo: false
knitr::include_graphics("../images/datatable/efficiency-summary.png")
```
...
#| out-width: "40%"
#| echo: false
knitr::include_graphics("../images/datatable/post-survey-QR-code.png")
```

<p style="text-align: center;">
[Post-Lecture Survey Link](https://forms.gle/yNuqDRHG9eibKH5P8)
</p>
